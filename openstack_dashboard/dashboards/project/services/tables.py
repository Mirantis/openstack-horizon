...
#
#
class CreateAdvancedService(tables.LinkAction):
    name = "create"
    verbose_name = _("Create Advanced Service")
    url = "horizon:project:services:create"
...
class AdvancedServicesTable(tables.DataTable):
    name = tables.Column("name",
                         verbose_name=_("Name"),
                         link='horizon:project:services:detail')
...
#                                verbose_name=_("Admin State"))
    ...
    class Meta:
        name = "services"
        verbose_name = _("Advanced Services")
