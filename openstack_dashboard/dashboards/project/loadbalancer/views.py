...
"""
Views for Quantum Load Balancing service.
"""
import logging
...
from openstack_dashboard.dashboards.project.loadbalancer.tabs import \
    LoadBalancerTabs
...
class IndexView(tabs.TabbedTableView):
    template_name = 'project/loadbalancer/index.html'
    tab_group_class = LoadBalancerTabs


#class VipsView(tables.DataTableView):
...
#    template_name = 'project/loadbalancer/detail.html'
